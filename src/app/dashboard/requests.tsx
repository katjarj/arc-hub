      ...
      <header className="bg-[#2B3A2B] text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="font-bold">Arc&apos;teryx Gear Request</span>
          </Link>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col md:flex-row gap-6">
            ...
            <Card>
              <CardContent className="p-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="border-b pb-3">
                    <p className="font-medium text-sm">Requests You&apos;re Fulfilling</p>
                    <p className="text-sm text-gray-500">1 request</p>
                  </div>
                  <div>
                    <p className="font-medium text-sm">Available Credits</p>
                    <p className="text-sm text-gray-500">{currentUser.credits} credits</p>
                  </div>
                </div>
          ...
          <div className="flex-1">
            ...
            <div className="flex justify-between items-center mb-6">
              <div className="flex items-center gap-2">
                <span className="text-gray-500">{openRequests.length} open requests</span>
              </div>
                          ...
                          <div className="flex flex-col md:flex-row gap-4">
                            <div className="md:w-1/4 flex flex-col">
                              <div className="flex items-center gap-2 mb-2">
                                <Badge className="bg-[#4A6741]">
                                  {request.credits} {request.credits === 1 ? "Credit" : "Credits"}
                                </Badge>
                            ...
                            <div className="md:w-3/4">
                              ...
                              <div className="flex justify-between items-center">
                                <span className="text-sm text-gray-500">Posted on {request.createdAt}</span>
